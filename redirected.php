...
<html>
  <head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha512-sB5PVP5g3EiZtZ3bBxIR6fJi/8DAKe/IMadG8VUeCwxBW6ScIQOpKO0ym1czrppktR9EM8r5CwD9A6QlCSBMJhA==" crossorigin="anonymous" />
        <link rel="icon" type="image/png" href="img/favicon.png">
        <style>
     html, body {
        margin: 0;
        height: 100%;
        margin-right: 107px; /* Adjust this value as needed */
        zoom: 1.0; /* Reset zoom */
    }
...
.main-page .text-wrapper{
    position: relative; width: 96px;     top: 26px;
    left: 219px;font-family: inter,sans-serif;font-weight: 700;color: #010333;font-size: 20px;letter-spacing: 0;line-height: normal;white-space: nowrap;
  }      
...
<div class="main-page" style="width:100% ;  left:-11px;">
      <div class="div" >
      <img class="image" src='img/image-31333-1.png'   />
    
    <div class="overlap">
    <div class="text-wrapper" ><a href="logout.php">LOG OUT</a></div>
    <?php
   
        if (isset($_SESSION["user_token"])) {
    echo "
              <li class='welcome-text'>Welcome: " . (isset($userinfo['full_name']) ? $userinfo['full_name'] : 'Guest') . "</li>
          ";
}
         if(isset($_SESSION["user"])) {
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td> Welcome:" . $row["full_name"] . "</td>";
    ...
    left:-11px;
    position: relative;">
    <a href="progress_page.php"><button class="button_dashboard" >My Dashboard</button></a>
      ...
      <div class="component" >
        <a href="Businessqualifications.php">
          <div class="overlap-group-2">
            <img class="screenshot-2" src="img/businessqual.png"  />
            <div class="business">Business<br />Qualifications</div>
          </div>
        </a>
      </div>
      ...
      <div class="overlap-group-wrapper">
        ...
        <div class="div-wrapper"  >
          ...
          <div class="overlap-5">
               <span class="text-wrapper-121" style="" >(Coming Soon)</span>
            <div class="text-wrapper-7" >Explore Colleges </div>
            <img class="screenshot-5" src= "img/explorecolleges.png"  />
          </div>
         
        </div>
        <div class="component-2"  >
         <a href="explorejobs.php">
          <div class="overlap-6">
            <div class="text-wrapper-8">Explore Jobs</div>
            <img class="screenshot-6" src= "img/explorejobsimage.png"  />
          </div>
         </a>
        </div>
        <div class="component-3"  >
          <a href="Blogs.php">
          <div class="overlap-7">
            <div class="text-wrapper-9">Blogs</div>
            <img class="screenshot-7" src= "img/blogspic.png"  />
          </div>
          </a>
        </div>
...
<a href="https://wa.me/923000855025" target="_blank">
    <img src="img/whatsapp-icon.png" alt="" class="whatsapp-icon">
        ...
        <div class="rectangle-10" style="width:100% ; " ></div>
